...
ACLOCAL = ${SHELL} /opt/dogecoin/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /opt/dogecoin/build-aux/missing autoconf
...
MAINT = 
MAKEINFO = ${SHELL} /opt/dogecoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
PACKAGE_STRING = Dogecoin Core 1.14.3
...
abs_srcdir = /opt/dogecoin
abs_top_builddir = /opt/dogecoin
abs_top_srcdir = /opt/dogecoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /opt/dogecoin/build-aux/install-sh
