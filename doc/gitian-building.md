...
*Setup instructions for a Gitian build of DigitalPay using a Debian VM or physical system.*
...
- [Building DigitalPay](#building-dogecoin-core)
...
To build DigitalPay (for Linux, OS X and Windows) just follow the steps under 'perform
