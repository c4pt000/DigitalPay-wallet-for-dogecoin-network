UNIX BUILD NOTES
====================
Some notes on how to build DigitalPay in Unix.
...
memory available when compiling DigitalPay. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build DigitalPay without wallet.
...
# Configure DigitalPay to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
...
As mentioned above, when maintaining portability of the wallet between the standard DigitalPay distributions and independently built
...
with 4.8-built DigitalPay is needed follow the steps under "Berkeley DB" above.
